        ...
        if ( buildtype == 8 ) then {
            ...
            while { build_confirmed == 1 && alive player } do {
                ...
                private _remove_objects = [];
                {
                    ...
                    if ((_x isKindOf "Animal") || (/* _typeOfX in KPLIB_collisionIgnoreObjects */ true) || (_typeOfX isKindOf "CAManBase") || (isPlayer _x) || (_x == _vehicle) || ((toLowerANSI (typeOf _vehicle)) in KPLIB_b_static_classes)) then {
